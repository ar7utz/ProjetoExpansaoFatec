...
<body class="bg-gray-50 font-sans">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 mt-6">
        <div class="flex flex-col">
            <div class="flex flex-row w-full mb-12">
                <div class="flex-[7] pr-8">
                    <h1 class="text-4xl font-extrabold text-gray-800 mb-6">Sociedade e Tecnologia</h1>
                    <p class="text-lg text-gray-700 leading-relaxed max-w-3xl mb-12">
                        Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia
                    </p>
                </div>
                <div class="flex-[3] flex flex-col items-center justify-center">
                    <h2 class="text-xl font-bold mb-2">Professor</h2><img class="w-40 h-40 rounded-lg object-contain mb-2" src="../../../assets/imgs/professores/69078e7396245_claude.png" alt="Foto do professor">                    <p class="text-md text-gray-700 font-semibold mb-2">Artur</p>
                    <p class="text-gray-600 text-sm text-center">Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia Sociedade e tecnologia</p>
                </div>
            </div>
        </div>
        ...
        <?php
            ...
            $nomeSala = "Sociedade e Tecnologia";
