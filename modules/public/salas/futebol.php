...
<body class="bg-gray-50 font-sans">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 mt-6">
            ...
            <div class="flex flex-row w-full mb-12">
                <div class="flex-[7] pr-8">
                    ...
                    <p class="text-lg text-gray-700 leading-relaxed max-w-3xl mb-12">
                        tes testestetestes testestetestes testestetestes testestetestes testestetestes testestetestes testestetestes testestetestes testestetestes testestetestes testestetestes testestetes
                    </p>
                </div>
                <div class="flex-[3] flex flex-col items-center justify-center">
                    <h2 class="text-xl font-bold mb-2">Professor</h2><img class="w-40 h-40 rounded-lg object-contain mb-2" src="../../../assets/imgs/professores/69079125879fe_vibes.jpeg" alt="Foto do professor">                    <p class="text-md text-gray-700 font-semibold mb-2">Artur</p>
                    <p class="text-gray-600 text-sm text-center">tes testestetestes testestetestes testestetestes testestetestes testestetestes testestetesv</p>
                </div>
            </div>
        </div>
        ...
        <?php
            ...
            // define Futebol no arquivo público (para que links use Futebol igual ao exemplo da sala github)
            $nome = "Futebol";
            $nomeSala = $nome;
